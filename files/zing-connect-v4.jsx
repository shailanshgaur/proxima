...
const vendors = [
  {
    ...
    capacity:"full", emoji:"🍳", responseTime:"Usually responds same day",
  ...
  },
  {
    ...
    capacity:"possibly-full", emoji:"🧹", responseTime:"Responds within a day",
  ...
  },
  {
    ...
    capacity:"available", emoji:"🍳", responseTime:"Responds within 2 hours",
    lastActive:"Active today", trending:false,
  ...
  },
  {
    ...
    capacity:"available", emoji:"🔧", responseTime:"Usually responds within 1 hr",
  ...
  },
  {
    ...
    capacity:"available", emoji:"❄️", responseTime:"Usually responds within 2 hrs",
    lastActive:"Active today", trending:false,
  ...
  },
  {
    ...
    capacity:"available", emoji:"⚡", responseTime:"Responds within a day",
              ...
              <div key={v.id} style={{
                ...
                <div style={{ padding: "14px" }}>
                  ...
                  <div style={{ display: "flex", gap: "12px" }}>
                    ...
                    {/* Avatar — NoBroker property photo style */}
                    <div style={{ position: "relative", flexShrink: 0 }}>
                      <div style={{ width: "56px", height: "56px", borderRadius: "12px", background: isRes ? "#e3fcef" : "#e8f4ff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "26px", border: `1.5px solid ${isRes ? "#b3f5d8" : "#b3d4f5"}` }}>
                        {v.emoji}
                      </div>
                      {/* UBER-style online dot */}
                      <div style={{ position: "absolute", bottom: "2px", right: "2px", width: "10px", height: "10px", borderRadius: "50%", background: v.lastActive.includes("today") ? "#00c853" : "#ffa000", border: "2px solid #fff" }} />
                    </div>
                      ...
                      <div key={idx} style={{ background: "#fff", borderRadius: "10px", padding: "10px 12px", marginBottom: "8px", border: "1px solid #ebecf0" }}>
                        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "5px" }}>
                          <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                            <div style={{ width: "24px", height: "24px", borderRadius: "50%", background: "#e8f4ff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "11px", fontWeight: "800", color: "#0066cc" }}>
                              {r.by.charAt(0)}
                            </div>
                            <div>
